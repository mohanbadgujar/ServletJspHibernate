	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-5 col-lg-5 col-sm-7 col-xs-11" id="form">
				...
				<form method="post" action="login" name="vinform">
					...
					<div class="form-group">
						<label class="control-label">Email</label> <span><i
							...
							class="form-control" onkeyup="sendInfo()" name="email" id="email"
					...
					<div class="form-group">
						<label class="control-label">Password</label> <span><i
							...
							class="form-control" name="pass" id="pass" placeholder="Password"
							onkeyup="sendInform()">
						<p id="ErrorPass"></p>
					...
					<div class="form-group">
						...
						<!-- onclick="javascript:return ValidateLogin(document.getElementById('email').value,document.getElementById('pass').value);"> -->
						<!-- 	<input type="submit" class="btn btn-danger" name="LogIn" value="Sign Up"> -->
